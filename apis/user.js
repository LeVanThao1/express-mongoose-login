...
const { authentication } = require('../middlewares/check-auth.js');
...
exports.load = (app) => {
    ...
    app.delete('/api/v1/users/:id',[ authentication, validate(userValidation.deleteUser()) ], controllerUser.deleteUser);
    app.get('/api/v1/users/:id', [ authentication, validate(userValidation.getUser()) ], controllerUser.getUser);
    app.get( '/api/v1/users', authentication, controllerUser.getListUser);
